...
public final class VotingFRM extends javax.swing.JFrame {
 ...
 BarsFRM b = new BarsFRM();
    ...
    public int getDiscord() {return Discord;}
    public void setDiscord(int Discord) { this.Discord = Discord; }
    ...
    public JLabel getCredits() {return Credits;}
    public void setCredits(JLabel Credits) {this.Credits = Credits;}

    public JLabel getDiscordIMG() { return DiscordIMG;}
    public void setDiscordIMG(JLabel DiscordIMG) { this.DiscordIMG = DiscordIMG;}
    ...
    public JLabel getTeamsIMG() {return TeamsIMG;}
    public void setTeamsIMG(JLabel TeamsIMG) { this.TeamsIMG = TeamsIMG; }

    public JLabel getZoomIMG() {return ZoomIMG;}
    public void setZoomIMG(JLabel ZoomIMG) {this.ZoomIMG = ZoomIMG;}
